...
var key = '206790a6d31e08d48216c29d43db2ef8';
var lat = '42.360081';
var lon = '-71.058884';
...
function drawWeather( d ) {
  ...
  // intro
$('.boston').html( convertTime(d.current.sunset) );
...
$('.day1 .description').html( printGraphic(d.daily[1].weather[0].description) );
...
$('.day2 .description').html( printGraphic(d.daily[2].weather[0].description) );
...
$('.day3 .description').html( printGraphic(d.daily[3].weather[0].description) );
...
$('.day4 .description').html( printGraphic(d.daily[4].weather[0].description) );
...
$('.day5 .description').html( printGraphic(d.daily[5].weather[0].description) );
...
$('.day6 .description').html( printGraphic(d.daily[6].weather[0].description) );
